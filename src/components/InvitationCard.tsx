...
export const InvitationCard = () => {
  return (
    <div className="relative w-full max-w-6xl mx-auto z-10 px-1 pt-4 sm:p-4 sm:pt-8 md:p-12 mt-2 sm:mt-4">
      ...
      >
        <div className="relative m-2 sm:m-4 md:m-6 border border-[rgba(169,138,75,0.55)] p-1.5 sm:p-2">
          {/* Inner border */}
          <div className="absolute inset-[4px] sm:inset-[6px] border border-[rgba(169,138,75,0.35)] pointer-events-none" />
          <div className="relative px-3 py-6 sm:px-6 sm:py-8 md:px-10 md:py-12 flex flex-col items-center text-center w-full min-w-0">
            ...
            >
              Vimal <span className="font-['Cormorant_Garamond'] italic font-normal text-[0.5em] text-[var(--color-ink)] px-[6px] md:px-[15px] align-middle">weds</span> Aishwariya
            </motion.h1>
            ...
            {/* Wedding Ceremony — from invitation card (Dindigul) */}
            <motion.div
              variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }} transition={{ delay: 0.95 }}
            ...
            <div className="w-full max-w-4xl mx-auto mt-8 sm:mt-12 mb-4 sm:mb-6 px-0 sm:px-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6 items-stretch relative">
                ...
                {/* Column 1: When */}
                <motion.div 
                  variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }} transition={{ delay: 0.1 }}
                ...
                >
                  ...
                  <div className="flex flex-col items-center gap-1">
                    <span className="font-['Cinzel'] text-[10px] md:text-[12px] tracking-[3px] text-[var(--color-gold-line)] uppercase font-semibold">Date</span>
                    <span className="font-['Cormorant_Garamond'] text-[28px] sm:text-[32px] md:text-[38px] text-black font-semibold mt-1 leading-none">01 Nov</span>
                    <span className="font-['Cormorant_Garamond'] text-[13px] sm:text-[14px] text-[var(--color-ink)] opacity-70 tracking-[2px] uppercase">Sunday</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span className="font-['Cormorant_Garamond'] text-[18px] sm:text-[20px] md:text-[22px] text-black font-medium mt-1">Reception</span>
                    <span className="font-['Cormorant_Garamond'] text-[12px] sm:text-[13px] text-[var(--color-ink)] opacity-60 tracking-[1px] uppercase mt-0.5">Evening</span>
                  </div>
                </motion.div>

                {/* Column 2: Where */}
                <motion.div 
                  variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }} transition={{ delay: 0.15 }}
                  className="flex flex-col items-center justify-center text-center p-4 sm:p-6 bg-[rgba(74,90,55,0.03)] rounded-xl sm:rounded-2xl border border-[rgba(169,138,75,0.18)] relative overflow-hidden"
                >
                  <div className="absolute top-0 inset-x-0 h-[2px] bg-gradient-to-r from-transparent via-[var(--color-gold-line)] to-transparent opacity-60" />
                  <div className="flex flex-col items-center gap-1">
                    <span className="font-['Cinzel'] text-[10px] md:text-[12px] tracking-[3px] text-[var(--color-gold-line)] uppercase font-semibold">Venue</span>
                    <span className="font-['Cormorant_Garamond'] text-[28px] sm:text-[32px] md:text-[38px] text-black font-semibold mt-2 leading-none italic">PV Garden</span>
                ...
                >
                  ...
                  <a href="https://www.google.com/maps/search/?api=1&query=PV+Garden+Bilathikulam+Calicut" target="_blank" rel="noopener noreferrer"
                    ...
                    <span className="font-['Cinzel'] text-[10px] md:text-[12px] tracking-[3px] text-[var(--color-gold-line)] uppercase font-semibold">Directions</span>
                    <span className="font-['Cormorant_Garamond'] text-[12px] sm:text-[13px] text-[var(--color-ink)] opacity-60">Tap to open Maps</span>
                  </a>
                </motion.div>
              </div>
            </div>
